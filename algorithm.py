                    ...
                    if m_left <= n_left <= m_right:  # skoree vsego nuzhno budet dobavit eshe odno uslovie o granicah s dregih storon
                        for count in range(len(use_fields)):
                            for durat in range(len(use_fields[count].day.mass_time) - 1):
                                if n_left <= use_fields[count].day.mass_time[durat] <= m_right and \
                        ...
                        for count in range(len(use_fields)):
                            for durat in range(len(use_fields[count].day.mass_time) - 1):
                                if n_right <= use_fields[count].day.mass_time[durat] <= m_right and \
                                        use_fields[count].day.mass_time[durat + 1] - use_fields[count].day.mass_time[
                                    durat] == 1.5 \
                                        and len(s) > q:
                                    k = Games(s[0], s[q + 1], str(use_fields[count].day.mass_time[durat]))
                        ...
                        for count in range(len(use_fields)):
                            for durat in range(len(use_fields[count].day.mass_time) - 1):
                                if m_right <= use_fields[count].day.mass_time[durat] <= n_right and \
                                        use_fields[count].day.mass_time[durat + 1] - use_fields[count].day.mass_time[
                                    durat] == 1.5 \
                                        and len(s) > q:
                                    k = Games(s[0], s[q + 1], str(use_fields[count].day.mass_time[durat]))
                        ...
                        for count in range(len(use_fields)):
                            for durat in range(len(use_fields[count].day.mass_time) - 1):
                                if m_left <= use_fields[count].day.mass_time[durat] <= n_right and \
                                        use_fields[count].day.mass_time[durat + 1] - use_fields[count].day.mass_time[
                                    durat] == 1.5 \
                                        and len(s) > q:
                                    k = Games(s[0], s[q + 1], str(use_fields[count].day.mass_time[durat]))
